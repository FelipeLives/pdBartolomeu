...
ci.registrar_investimentos("Tesouro Direto", "Taxa Selic", 100)
ci.registrar_investimentos("Tesouro Direto", "Taxa Selic", 300)
ci.registrar_investimentos("Tesouro Direto", "Taxa Selic", 50)
ci.registrar_investimentos("Tesouro Direto", "Taxa Selic", 10)
ci.registrar_investimentos("Tesouro Direto", "Taxa Selic", 20)
ci.registrar_investimentos("Tesouro Direto", "Taxa Selic", 90)
